...
let gameCount = document.getElementById("clickCount").innerText;
...
function startGame() {
    ...
    var gameCounter = document.getElementById("round");
    ...
    if (this != "") {
        gameCount+=1
        gameCounter.innerHTML = gameCount;
    }
    ...
    for (i = 0; i < simonButton.length; i++) {
        ...
        simonButton[i].addEventListener("mouseup", function () {
            ...
            if (userNum === gameNum[playerClickCount] && playerClickCount < round) {
                ...
                counter = 0
                playerClickCount = 0
                document.getElementById("clickCount").innerText = round
                setTimeout(function () {
                    computerChoice()
                }, 1000);
            } else {
